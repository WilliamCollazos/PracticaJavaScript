(function () {
    var init = function () {
        ...
        var qtyFields = orderForm.quantity,
            totalFields = document.getElementsByClassName('item_total'), orderTotalField = document.getElementById('order_total');
        ...
        var calculateTotals = function () {
            ...
            for (; i < ln; i++) {
                ...
                if (!!qtyFields[i].dataset) {
                    ...
                    itemPrice = parseFloat(qtyFields[i].getAttribute('dataprice'));
                }
        ...
        var validateForm = function () {
            ...
            if (orderForm.password.value !=
                orderForm.confirm_password.value) {
                doCustomValidity(
